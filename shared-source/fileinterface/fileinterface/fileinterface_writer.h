...
#ifndef __imputation_comparison_FILEINTERFACE_FILEINTERFACE_WRITER_H__
#define __imputation_comparison_FILEINTERFACE_FILEINTERFACE_WRITER_H__
...
#endif //__imputation_comparison_FILEINTERFACE_FILEINTERFACE_WRITER_H__
